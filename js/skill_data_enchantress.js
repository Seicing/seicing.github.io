...
<td align="center" colspan="7" id="ghost_chain_slash3"></td>
 ...
 <a href="https://seicing.com/res/dnfclass/skillgif/女巫/偏爱.gif" onmouseout="hiddenPic();" onmousemove="showPic(event,'https://seicing.com/res/dnfclass/skillgif/女巫/偏爱.gif');">这里输入文字</a>
                ...
                <img src="http://47.236.171.173/seicingdepot/dfclass/icon/skill/魔法攻击.png" title="魔法攻击"><img src="http://47.236.171.173/seicingdepot/dfclass/icon/skill/攻击.png" title="攻击"><img src="http://47.236.171.173/seicingdepot/dfclass/icon/skill/抓取.png" title="抓取"><img src="http://47.236.171.173/seicingdepot/dfclass/icon/skill/固定伤害.png" title="固定伤害"><img src="http://47.236.171.173/seicingdepot/dfclass/icon/skill/BUFF.png" title="BUFF">
  <img src="http://47.236.171.173/seicingdepot/dfclass/icon/skill/魔法攻击.png" title="魔法攻击"><img src="http://47.236.171.173/seicingdepot/dfclass/icon/skill/攻击.png" title="攻击"><img src="http://47.236.171.173/seicingdepot/dfclass/icon/skill/固定伤害.png" title="固定伤害"><img src="http://47.236.171.173/seicingdepot/dfclass/icon/skill/BUFF.png" title="BUFF"><img src="http://47.236.171.173/seicingdepot/dfclass/icon/skill/无色技能.png" title="无色技能">
  <img src="http://47.236.171.173/seicingdepot/dfclass/icon/skill/魔法攻击.png" title="魔法攻击"><img src="http://47.236.171.173/seicingdepot/dfclass/icon/skill/攻击.png" title="攻击"><img src="http://47.236.171.173/seicingdepot/dfclass/icon/skill/固定伤害.png" title="固定伤害"><img src="http://47.236.171.173/seicingdepot/dfclass/icon/skill/无色技能.png" title="无色技能">
