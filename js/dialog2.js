                ...
                .then(json => {
                    const processedData = json.map(item => {
                        ...
                        return {
                            ...
                            attach5: `https://data.seicing.com/seicingdepot/essay/chara/${characterid}/attach.png`,
                            special5: `https://data.seicing.com/seicingdepot/essay/chara/${characterid}/special.png`,
                            sweat5: `https://data.seicing.com/seicingdepot/essay/chara/${characterid}/sweat.png`,
                            redface5: `https://data.seicing.com/seicingdepot/essay/chara/${characterid}/red_face.png`,
                            brow5: `https://data.seicing.com/seicingdepot/essay/chara/${characterid}/${item['brow']}.png`,
                            eyeclose5: `https://data.seicing.com/seicingdepot/essay/chara/${characterid}/${item['eye3']}.png`,
                            eye5: `https://data.seicing.com/seicingdepot/essay/chara/${characterid}/${item['eye']}.png`,
                            mouth5: `https://data.seicing.com/seicingdepot/essay/chara/${characterid}/${item['mouth']}.png`,
                            base5: `https://data.seicing.com/seicingdepot/essay/chara/${characterid}/base.png`,
                            base6: `https://data.seicing.com/seicingdepot/essay/chara/${characterid}/base2.png`
                        };
                    });
