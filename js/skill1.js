function showPic(e, taitou, kontie) {
    ...
    aasb.innerHTML = "<div style='background:url($res/2fatcatpool/header.png) no-repeat;padding:7px 7px 0px 7px;'><font style='color:#ffc400;font-family: SimSun;'>" + taitou + "</font><br><img src='$res/2fatcatpool/line.png'></div><div style='background:url($res/2fatcatpool/midder.png) repeat-y;padding:0px 7px 0px 7px;'><font style='color:#ffffff;font-family: SimSun;'>" + kontie + "</font></div>  <div style='background:url($res/2fatcatpool/ender.png) no-repeat;'><font style='color:#ffffff;'><p>&nbsp</p></font></div>";
    var div = aasb;
