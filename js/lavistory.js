                ...
                .then(json => {
                    const processedData = json.map(item => {
                        ...
                        const commonAstyle = "padding: 5px;border-radius: 15px;background: var(--labibanadialog);" +
                            `background-image: url(https://data.seicing.com/seicingdepot/essay/chara/${item.char}/${attach}.png),` +
                            `url(https://data.seicing.com/seicingdepot/essay/chara/${item.char}/${special}.png),` +
                            `url(https://data.seicing.com/seicingdepot/essay/chara/${item.char}/${sweat}.png),` +
                            `url(https://data.seicing.com/seicingdepot/essay/chara/${item.char}/${red_face}.png),` +
                            `url(https://data.seicing.com/seicingdepot/essay/chara/${item.char}/${brow}.png),` +
                            `url(https://data.seicing.com/seicingdepot/essay/chara/${item.char}/${eye}.png),` +
                            `url(https://data.seicing.com/seicingdepot/essay/chara/${item.char}/${mouth}.png),` +
                            `url(https://data.seicing.com/seicingdepot/essay/chara/${item.char}/${baseys}.png);` +
