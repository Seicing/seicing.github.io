...
function renderComments(results, floor) {
    ...
    for (var i = results.length - 1; i >= 0; i--) {
        ...
        var authorHTML = (author === 'python script' || author === 'python script -D') ? '<img src="https://seicing.com/res/seicingsign.png"><font color="red">精锐战猫</font>' : author;
        htmlContent += `<div style="width:100%; max-width: 750px; overflow-wrap: break-word;"><div>${text}</div><br><div style="text-align: right;">${(floor + i + 1)}楼  Posted by: ${authorHTML} | ${formattedTime}</div><hr class="hrsty"></div>`;
    }
