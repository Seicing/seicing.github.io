...
function tipsg(a, b) {
    ...
    aaposbo1.src = 'https://data.seicing.com/seicingdepot/essay/forte/' + a + '新兵.png';
    var aaposbo2 = document.querySelector("#Warrior");
    aaposbo2.src = 'https://data.seicing.com/seicingdepot/essay/forte/' + a + '武士.png';
    var aaposbo3 = document.querySelector("#Phalanx");
    aaposbo3.src = 'https://data.seicing.com/seicingdepot/essay/forte/' + a + '兵方队.png';
    var aaposbo4 = document.querySelector("#Skirmisher");
    aaposbo4.src = 'https://data.seicing.com/seicingdepot/essay/forte/' + a + '散兵.png';
    var aaposbo5 = document.querySelector("#Vanguard");
    aaposbo5.src = 'https://data.seicing.com/seicingdepot/essay/forte/' + a + '先锋.png';

    var aaposbo6 = document.querySelector("#Mage");
    aaposbo6.src = 'https://data.seicing.com/seicingdepot/essay/forte/' + a + '法师.png';
    var aaposbo7 = document.querySelector("#Sorceress");
    aaposbo7.src = 'https://data.seicing.com/seicingdepot/essay/forte/' + a + '魔击手.png';
    var aaposbo8 = document.querySelector("#Scholar");
    aaposbo8.src = 'https://data.seicing.com/seicingdepot/essay/forte/' + a + '学者.png';
    var aaposbo9 = document.querySelector("#Cleric");
    aaposbo9.src = 'https://data.seicing.com/seicingdepot/essay/forte/' + a + '神官.png';
    var aaposbo10 = document.querySelector("#Wizard");
    aaposbo10.src = 'https://data.seicing.com/seicingdepot/essay/forte/' + a + '术士.png';

    var aaposbo11 = document.querySelector("#Ranger");
    aaposbo11.src = 'https://data.seicing.com/seicingdepot/essay/forte/' + a + '游兵.png';
    var aaposbo12 = document.querySelector("#Sentinel");
    aaposbo12.src = 'https://data.seicing.com/seicingdepot/essay/forte/' + a + '近卫.png';
    var aaposbo13 = document.querySelector("#Citizen");
    aaposbo13.src = 'https://data.seicing.com/seicingdepot/essay/forte/' + a + '市民.png';
...
function tipsb(a, b) {
    ...
    aaposbo1.src = 'https://data.seicing.com/seicingdepot/essay/forte/西西景' + a + '.png';
    var aaposbo2 = document.querySelector("#CentralSeigine");
    aaposbo2.src = 'https://data.seicing.com/seicingdepot/essay/forte/中央西景' + a + '.png';
    var aaposbo3 = document.querySelector("#SouthernSeigine");
    aaposbo3.src = 'https://data.seicing.com/seicingdepot/essay/forte/南西景' + a + '.png';
    var aaposbo4 = document.querySelector("#NorthernSeigine");
    aaposbo4.src = 'https://data.seicing.com/seicingdepot/essay/forte/北西景' + a + '.png';

    var aaposbo11 = document.querySelector("#EasternSeigine");
    aaposbo11.src = 'https://data.seicing.com/seicingdepot/essay/forte/东西景' + a + '.png';

    var aaposbo5 = document.querySelector("#GrandDelta");
    aaposbo5.src = 'https://data.seicing.com/seicingdepot/essay/forte/大三角洲' + a + '.png';

    var aaposbo6 = document.querySelector("#EasternAlterrata");
    aaposbo6.src = 'https://data.seicing.com/seicingdepot/essay/forte/东艾特拉塔' + a + '.png';
    var aaposbo7 = document.querySelector("#WesternAlterrata");
    aaposbo7.src = 'https://data.seicing.com/seicingdepot/essay/forte/西艾特拉塔' + a + '.png';
    var aaposbo8 = document.querySelector("#InnerAlterrata");
    aaposbo8.src = 'https://data.seicing.com/seicingdepot/essay/forte/内艾特拉塔' + a + '.png';
    var aaposbo9 = document.querySelector("#IuireMainland");
    aaposbo9.src = 'https://data.seicing.com/seicingdepot/essay/forte/尤伊本岛' + a + '.png';
    var aaposbo10 = document.querySelector("#IuireSeparation");
    aaposbo10.src = 'https://data.seicing.com/seicingdepot/essay/forte/尤伊离岛' + a + '.png';

    var aaposbo12 = document.querySelector("#OuterSeigine");
    aaposbo12.src = 'https://data.seicing.com/seicingdepot/essay/forte/外西景' + a + '.png';
